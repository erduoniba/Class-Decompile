...
//  Repository is https://github.com/erduoniba/Class-Decompile
//  Copyright © 2024 www.poboke.com. All rights reserved.
//
...
def start_decompile(input_class_name=None):
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        ...
        for class_name in classes:
            ...
            future = executor.submit(write_to_file, file_path, codes)
